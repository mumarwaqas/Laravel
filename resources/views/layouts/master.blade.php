...
<html lang="en">
   <head>
      ...
      <script ' }}"https://oss.maxcdn.com/respond/1.4.2/respond.min.js"></script><![endif]-->
   </head>
   <!-- body -->
         ...
         <div class="head">
            <div  class="container">
               <div class="row ">
                  <div  class="col-md-6">
                     <ul class="email_call">
                        <li><a href="#"><img  src="{{  asset('icon/2.png') }}" alt="#"/>(+71)1234567890</a></li>
                        <li><a href="#"><img  src="{{  asset('icon/1.png') }}" alt="#"/>demo@gmail.com</a></li>
                     </ul>
                  </div>
                  <div  class="col-md-6">
